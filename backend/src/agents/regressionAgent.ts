...
export async function runRegressionAgent(snapshot: RepoSnapshot): Promise<RegressionRisk[]> {
  // Simple heuristic stub for now (no ML yet).
  // Example: more LOC → higher risk, or modules named "auth" are riskier.
